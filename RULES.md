...
Documentation lives under the /docs directory. When creating a new document, create it there.

After each phase, write what we completed into progress.md and commit github

If context is low—below 10%—and you’re about to start a new phase, first run /compact, then start that phase.
